...
\centering
\begin{tikzpicture}
\tikzset{roundnode/.style={circle, draw=black!100, thick, minimum size=1mm, fill=white!100}}
...
\node[label=below left:$O$] at (0,0) {};
\node[label=above right:$F$] at (7,7) {};
...
\exercice
Soit $\mathbb U_n$ l'ensemble des nombres complexes $a$ de module 1 tels que $a^n=1$, où $n\geq 2$.
