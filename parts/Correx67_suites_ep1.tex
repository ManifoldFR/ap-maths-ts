...
\begin{equation*}u_n\xrightarrow[n\to+\infty]{}2.\end{equation*}
...
{\color{incolor}In [{\color{incolor}1}]:} \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
        ...
        \PY{k}{def} \PY{n+nf}{flot}\PY{p}{(}\PY{n}{u0}\PY{p}{,}\PY{n}{n}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{def} \PY{n+nf}{build\PYZus{}flow}\PY{p}{(}\PY{n}{prems}\PY{p}{,}\PY{n}{nmaxs}\PY{p}{,}\PY{n}{placement}\PY{p}{)}\PY{p}{:}
            \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Construction des graphes des suites (u\PYZus{}n)\PYZdq{}\PYZdq{}\PYZdq{}}
            \PY{n}{nb\PYZus{}g} \PY{o}{=} \PY{n+nb}{max}\PY{p}{(}\PY{n}{placement}\PY{p}{)}\PY{o}{+}\PY{l+m+mi}{1}
            \PY{n}{fig}\PY{p}{,}\PY{n}{ax} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{nb\PYZus{}g}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{)}\PY{p}{)}
            \PY{k}{for} \PY{n}{i}\PY{p}{,}\PY{p}{[}\PY{n}{p}\PY{p}{,} \PY{n}{s}\PY{p}{,} \PY{n}{u0}\PY{p}{]} \PY{o+ow}{in} \PY{n+nb}{enumerate}\PY{p}{(}\PY{n+nb}{zip}\PY{p}{(}\PY{n}{placement}\PY{p}{,}\PY{n}{styl}\PY{p}{,}\PY{n}{prems}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                \PY{n}{ax}\PY{p}{[}\PY{n}{p}\PY{p}{]}\PY{o}{.}\PY{n}{plot}\PY{p}{(}\PY{n}{flot}\PY{p}{(}\PY{n}{u0}\PY{p}{,}\PY{n}{nmaxs}\PY{p}{[}\PY{n}{p}\PY{p}{]}\PY{p}{)}\PY{p}{,}\PY{n}{s}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{l+s+s1}{r\PYZsq{}}\PY{l+s+s1}{\PYZdl{}u\PYZus{}0=}\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{u0}\PY{p}{)}\PY{p}{)}
                \PY{c+c1}{\PYZsh{} ajoute les points de la liste L au graphe}
            \PY{k}{for} \PY{n}{axi} \PY{o+ow}{in} \PY{n}{ax}\PY{p}{:}
                \PY{n}{axi}\PY{o}{.}\PY{n}{grid}\PY{p}{(}\PY{p}{)}
                \PY{n}{axi}\PY{o}{.}\PY{n}{legend}\PY{p}{(}\PY{n}{loc}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
                \PY{n}{axi}\PY{o}{.}\PY{n}{margins}\PY{p}{(}\PY{n}{y}\PY{o}{=}\PY{l+m+mf}{0.06}\PY{p}{)} \PY{c+c1}{\PYZsh{} marge additionnelle sur l\PYZsq{}axe des ordonnées}
                \PY{n}{axi}\PY{o}{.}\PY{n}{set\PYZus{}xlabel}\PY{p}{(}\PY{l+s+s1}{r\PYZsq{}}\PY{l+s+s1}{\PYZdl{}n\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{c+c1}{\PYZsh{} titre axe des abscisses}
                \PY{n}{axi}\PY{o}{.}\PY{n}{set\PYZus{}ylabel}\PY{p}{(}\PY{l+s+s1}{r\PYZsq{}}\PY{l+s+s1}{\PYZdl{}u\PYZus{}n\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{c+c1}{\PYZsh{} titre axe des ordonnées}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n}{prems} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mf}{1.003}\PY{p}{,} \PY{l+m+mf}{2.91}\PY{p}{,} \PY{l+m+mf}{3.01}\PY{p}{,} \PY{l+m+mf}{0.996}\PY{p}{]}
        \PY{n}{nmaxes} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{16}\PY{p}{,} \PY{l+m+mi}{8}\PY{p}{]}
        \PY{n}{placement} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{styl} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZca{}\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZca{}\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{p\PYZhy{}.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}\PYZhy{}.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}\PYZhy{}.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.\PYZhy{}.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{n}{build\PYZus{}flow}\PY{p}{(}\PY{n}{prems}\PY{p}{,}\PY{n}{nmaxes}\PY{p}{,}\PY{n}{placement}\PY{p}{)}
\end{Verbatim}
